...
myFolder = 'C:\Users\Sarah\Documents\MATLAB\CONVERGENCE_POP\450_CSA';
...
f_in=fullfile(myFolder,'450_CSA_12_TBA_traj.txt');
...
fname1 =  sprintf('%d_%s_Count_Matrix_TBA_%d.txt',temp,pep,lag);
dlmwrite(fname1, CM, 'delimiter', '\t');

fname2 =  sprintf('%d_%s_Check_Index_%d.txt',temp,pep,lag);
