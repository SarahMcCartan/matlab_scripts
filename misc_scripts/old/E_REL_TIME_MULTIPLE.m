...
filePattern = fullfile(myFolder, '310_CSA_KM_0*.txt'); % Change to whatever pattern you need.
theFiles = dir(filePattern);

lagfile = fullfile(myFolder, '310_CSAt_lagTime.txt'); %read in lag time step file
