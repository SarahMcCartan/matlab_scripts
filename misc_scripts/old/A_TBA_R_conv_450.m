...
pep = 'CSA_NOV_F'; %csa or dcsa peptide string
lag = 1; %lag time
ns = 4;
...
n_iter = 0; %use this for file names

%for R = 0.04:0.02:0.22
R= 0.16;
n_iter = 8;
...
%CORRECTED STATE NAMES BY COMPARING POPULATIONS & TBA TRAJS & CLUSTER PLACEMENT
	...
	fname11 =  sprintf('R%04d_%d_%s_count_matrix_TBA.txt',n_iter,temp,pep);
	fname12 =  sprintf('R%04d_%d_%s_Life_T_Avg.txt',n_iter,temp,pep);
