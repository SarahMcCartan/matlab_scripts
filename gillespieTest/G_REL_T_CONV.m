...
filePattern = fullfile(myFolder, '2_TEST_KM_REL_T_*.txt'); % Change to whatever pattern you need.
theFiles = dir(filePattern);

lagFile = fullfile(myFolder, '2_TEST_lagVals.txt'); %read in lag t file
...
file_name = sprintf('%d_%s_KM_relTvslagT.txt',temp,pep);
